...
// 				Eigen::Matrix2d Jpd;
// 				Jpd.row(0) = Eigen::Vector2d(-config.sy * c12 - config.sx * s12 - l1.length * c1a, -config.sy * c12 - config.sx * s12);
// 				Jpd.row(1) = Eigen::Vector2d(-config.sy * s12 + config.sx * c12 - l1.length * s1a, -config.sy * s12 + config.sx * c12);
...
// 				runtime_data[i].lp_pos_desired = Eigen::Vector2d{ config.xpcg.pos, config.ypcg.pos };
// 				runtime_data[i].lp_vel_desired = Eigen::Vector2d{ config.xpcg.vel, config.ypcg.vel };
// 				runtime_data[i].lp_acc_desired = Eigen::Vector2d{ 0, config.ypcg.acc };
